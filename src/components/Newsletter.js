...
const Newsletter = () => {
  ...
  return (
    <section className="section bg-newsletter min-h-[490px]">
      <div className="conatiner max-auto flex justify-center lg:justify-end">
        <div className="w-full max-w[558px] text-center text-white lg:text-left">
          ...
          <div className="flex flex-col lg:flex-row gap-[22px]">
            ...
            />
            <button className="bg-primary h-[60px] hocer:bg-slate-900 px-7 rounded-lg font-medium text-xl transition">
              {buttonText}
            </button>
          </div>
        </div>
